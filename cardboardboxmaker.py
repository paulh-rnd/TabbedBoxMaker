...
class BoxMaker(inkex.Effect):
  ...
  def effect(self):
    ...
    # First Side
    if (boxtop != 1):
        h+=f"l {t5},0 l 0,-{t2-k2} l -{t5},0 " # Fold Notch

        if (boxtop == 2):
            # Flat top - Full Depth top on one side
            h+=f"l 0,-{dd+(k2)} "
            h+=f"l {ww+(k2)},0 "
            h+=f"l 0,{dd+(k2)} "
        else:
        ...
        h+=f"l {ww+k2},0 " # Top side is open
    h+=f"l 0,{t5} l {t2-(k2)},0 l 0,-{t5} " # Fold Notch
    ...
    if (boxtop == 3):
        ...
        h+=f"l {dd+k2},0 " # Open Top 
    h+=f"l 0,{t5} l {t2-k2},0 l 0,-{t5} " # Fold Notch

    # Third Side (Same as First, Except Flat Top)
    if (boxtop == 3):
        h+=f"l {t5},0 l 0,-{t2-k2} l -{t5},0 " # Fold Notch
    ...
    # Fourth Side (Same as second, with no trailing notch)
    if (boxtop == 3):
        h+=f"l {t5},0 l 0,-{t2-k2} l -{t5},0 " # Fold Notch
    ...
    boxtype = 2 # self.options.boxtype
